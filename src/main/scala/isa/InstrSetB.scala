...
object InstrSetB extends InstrProvider {
    ...
    def instructions: Array[InstrEntry] = Array(
        ...
        InstrEntry(BitPat("b0000100_00000_?????_100_?????_0111011"), ALU(ALUOps.ZEXTH, OpSel.RS1, OpSel.ZERO), Extension.Zbb),
        ...
        InstrEntry(BitPat("b000010_??????_?????_001_?????_0011011"), ALU(ALUOps.SLLIUW, OpSel.RS1, OpSel.IMM), Extension.Zba),
